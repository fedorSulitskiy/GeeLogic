...
class MockTagsInput extends StatefulWidget {
  const MockTagsInput({super.key, this.width = 900.0});

  final double width;

  @override
  State<MockTagsInput> createState() => _TagsInputState();
}

class _TagsInputState extends State<MockTagsInput> {
                      ...
                      title: TextButton(
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            // Remove the tag from the api response list.
