                          ...
                          TextButton(
                            onPressed: () {
                              setState(() {
                                ...
                                _codeController!.text = _codeChanged ? currentCode : "print('Hello world')";
                              });
                            },
                            child: Text(
                              '<< Python',
                          ...
                          TextButton(
                            onPressed: () {
                              setState(() {
                                ...
                                _codeController!.text = _codeChanged ? currentCode : "console.log('Hello world');";
                              });
                            },
                            child: Text(
                              'JavaScript >>',
